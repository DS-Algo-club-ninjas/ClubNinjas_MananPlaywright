...
- region "Notifications (F8)":
  - list:
    - status:
      - text: Registration Successful Your MANAN Medical Assistant account has been created.
      - button:
        - img
- status: Notification Registration SuccessfulYour MANAN Medical Assistant account has been created.
```